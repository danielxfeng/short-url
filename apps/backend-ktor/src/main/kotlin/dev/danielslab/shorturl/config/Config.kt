...
data class Config(
    ...
    companion object {
        ...
        fun fromEnv(application: Application): Config =
            Config(
        ...
        private fun envString(
            key: String,
            default: String? = null,
        ): String = System.getenv(key) ?: dotenv[key] ?: default ?: error("Environment variable $key is missing")
