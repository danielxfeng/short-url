...
class PqRepository(
...
) : UserRepository, LinkRepository {
    override suspend fun getUserById(id: Int): User? = dbExecutor.query {
        UsersTable
            .selectAll()
    ...
    override suspend fun deleteUserById(id: Int): Unit = dbExecutor.query {
        val deletedRows = UsersTable
    ...
    override suspend fun getLinkByCode(code: String): Link? = dbExecutor.query {
        LinksTable
            .selectAll()
    ...
    override suspend fun getLinkByCodeWithDeleted(code: String): Link? = dbExecutor.query {
        LinksTable
            .selectAll()
    ...
    override suspend fun getLinksByUserId(request: LinkListInput): List<Link> = dbExecutor.query {
        LinksTable
            .selectAll()
    ...
    override suspend fun softDeleteLinkById(request: LinkDeleteInput): Unit = dbExecutor.query {
        val updatedRows = LinksTable
            .update({
    ...
    override suspend fun restoreLinkById(request: LinkDeleteInput): Unit = dbExecutor.query {
        val updatedRows = LinksTable.update({
    ...
    override suspend fun permanentlyDeleteLinkById(request: LinkDeleteInput): Unit = dbExecutor.query {
        val deletedRows = LinksTable.deleteWhere {
            (LinksTable.userId eq request.userId) and (LinksTable.code eq request.code) and (LinksTable.deletedAt.isNotNull())
        }
    ...
    override suspend fun setLinkClicked(code: String): Int = dbExecutor.query {
        LinksTable
            .updateReturning(
