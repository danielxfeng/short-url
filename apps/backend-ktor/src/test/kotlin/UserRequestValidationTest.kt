...
class UserRequestValidationTest {
    @Test
    fun `accepts valid user payload with provider and providerId`() =
        testApplication {
    ...
    @Test
    fun `accepts null displayName and null profilePicture`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `accepts omitted displayName`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `accepts omitted profilePicture`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects invalid provider enum`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects invalid provider type`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects missing providerId`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects invalid providerId type`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `accepts non-null displayName`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects invalid displayName type`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects too long displayName`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `accepts non-null profilePicture`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects blank profilePicture`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects too long profilePicture`() =
        testApplication {
            application { validationTestModule() }
    ...
    @Test
    fun `rejects invalid profilePicture type`() =
        testApplication {
            application { validationTestModule() }
