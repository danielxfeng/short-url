...
class LinkRequestValidationTest {
    @Test
    fun `accepts valid link create request`() = testApplication {
        application { linkValidationTestModule() }

        val response = client.post("/links") {
    ...
    @Test
    fun `accepts null note`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `accepts omitted note`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects blank code on create`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects too long code on create`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects blank note`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects too long note`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects non-http url`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects localhost url`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects private ip url`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects invalid code type on create`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects invalid note type`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects invalid originalUrl type`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `accepts valid delete request`() = testApplication {
        application { linkValidationTestModule() }

        val response = client.post("/links/delete") {
            contentType(ContentType.Application.Json)
    ...
    @Test
    fun `rejects blank code on delete`() = testApplication {
        application { linkValidationTestModule() }
    ...
    @Test
    fun `rejects too long code on delete`() = testApplication {
        application { linkValidationTestModule() }
